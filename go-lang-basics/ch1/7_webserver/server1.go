...
var palette = []color.Color{color.Black, color.RGBA{0, 0xFF, 0, 0xFF},
	color.RGBA{0xFF, 0, 0, 0xFF}, color.RGBA{0, 0, 0xFF, 0xFF} }
...
func main() {
	...
	http.HandleFunc("/lissajous", func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "Cannot convert the cycles variable to int\n")
			fmt.Fprintf(w, "Cannot convert the cycles variable to int\n")
		}
		lissajous(w, cycles)
	})
